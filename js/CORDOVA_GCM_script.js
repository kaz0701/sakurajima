...
document.addEventListener('deviceready', function() {
  ...
  //
  window.plugins.GCM.register("71526552169", "GCM_Event", GCM_Success, GCM_Fail );
...
GCM_Event(e)
{
  ...
  case 'registered':
    ...
    if ( gApp.gcmregid.length > 0 )
    {
      ...
      // ==============================================================================
      // ==============================================================================
      $.post('http://www21292u.sakura.ne.jp/sakurajima/db_insert.php', 'reg_id='+gApp.gcmregid, function(msg){alert(msg);});
